...
Category: KMFD Cores
Emulated System: OpenBOR
Command Line Arguments: /bin/openbor
----------------------------
![km](https://i.imgur.com/0vmVy1c.png)

Mini Classics Execution by madmonkey; UI Integration by bslenul; Performance and Optimization by KMFDManic 

Very special thanks to Senile Team!

OpenBOR is a uniquely "Special" emulator that is capable of running "full speed ahead" on both RetroPie/Mini Classics, which share roughly the same Architectures.  "Special" is the key word here, as this is atypical from the normal Cores we have all become accustomed to!
